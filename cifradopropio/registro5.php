...
<div style="margin-left: 30%; margin-right:30%;">
    ...
    <form action="insertar.php" method="POST">
        ...
        <label for="cod_cliente"><b>Codigo de cliente:</b></label><input type="number" class="form-control mb-3"
            name="codigo1" required>

        <label for="cod_cliente"><b>Nombres:</b></label><input type="text" class="form-control mb-3" name="nombre"
            required>
        ...
        <label for="cod_cliente"><b>Contraseña:</b></label><input type="password" class="form-control mb-3" name="passw"
            placeholder="Contraseña" id="contrasenia">
        ...
        <center>
            <div class="col-md-8">
                <table class="table table-dark table-sm">
                    ...
                    ?>
                        <tr>
                            <th><?php echo $row['codigo1'] ?></th>
                            <th><?php echo $row['nombre'] ?></th>
                            <th><?php echo $row['matricula'] ?></th>
                            <th><?php echo $row['passw'] ?></th>
                            <th><a href="actualizar.php?id=<?php echo $row['codigo1'] ?>" class="btn btn-info">Editar</a>
                            </th>
                            <th><a href="delete.php?id=<?php echo $row['codigo1'] ?>" class="btn btn-danger">Eliminar</a>
                            </th>
                        </tr>
                        <?php
                    }
